    ...
    return (
        <div className='createfrompicturepage'>
            ...
            <div className='item'>
                ...
                {images.length === 0 ? (<p className='Scottytitle'>No search results. Maybe use a Scotty?</p>) : (<div className="image-grid">
                    {images.map((image) => (
                        <button
                            key={image.id} // Assuming each image has a unique identifier
